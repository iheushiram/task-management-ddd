...
export const taskApi = {
  ...
  createTask: async (data: CreateTaskRequest): Promise<CreateTaskResponse> => {
    const response: AxiosResponse<CreateTaskResponse> = await apiClient.post(
      "/tasks",
      data,
    )
  ...
  updateTaskStatus: async (
    ...
    const response: AxiosResponse<UpdateTaskStatusResponse> =
      await apiClient.put(`/tasks/${taskId}/status`, data)
    return response.data
  },
